...
<?php $type = $attribute[0]->category_type ?? ''; 	?>
<?php $id = $attribute[0]->category_id ?? ''; 	?>
<?php $update_id = $attribute[0]->id ?? ''; 	?>
						
<div class="main-panel">
        <div class="content-wrapper">
         
		  
		  <h4> Edit Attribute  : </br>
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <form class="form-sample" method="post" action="{{route('update_attribute')}}" data-parsley-validate="" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control"   required="" value="{{$attribute[0]->title}}" id="title" name="name">
                          </div>
                        </div>
                      </div>
                    </div>
						   ...
						   <?php $attr = 1 ; ?>
							  @foreach($attribute_options as $key)
								<div class="row">
								 ...
								 <div class="col-md-6">
									<div class="form-group row">
									  ...
									  <div class="col-sm-9">
										<input type="text" class="form-control"  value="{{$key->title}}" required="" name="option[]">
									  </div>
									</div>
								  </div>
								 <div class="col-md-2">
								 ...
								 <?php } else { ?> 
									<div class="col-md-6" id="removediv{{$attr}}">
										<div class="form-group row">
											<label class="col-sm-3 col-form-label">Option</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" required="" value="{{$key->title}}"  name="option[]">
											</div>
										</div>
									</div>
									<div class="col-md-2" id="removebtndiv{{$attr}}">
										<a href="javascript:;" class="btn btn-outline-danger btn_remove" data-id="{{$attr}}">
