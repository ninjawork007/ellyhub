          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="col-md-12">
                    <a href="{{route('add_pin_code')}}" class="btn btn-outline-secondary btn-fw float-right"><i class="fa fa-plus"></i></a>
                  </div>
...
<script>
    $(document).ready(function() {
        var table = $("#myTable").DataTable({
            ...
            stateSave: true,
            ajax: {
                url: "{{route('ajax_get_pincodes')}}", // json datasource
