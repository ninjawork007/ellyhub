...
<div class="main-panel">
        <div class="content-wrapper">
          <h4 class="card-title">Product Bundle</h4>
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="col-md-12">
                    <a href="{{route('add_bundle')}}" class="btn btn-outline-secondary btn-fw float-right"><i class="fa fa-plus"></i></a>
                  </div>
                    ...
                    <table class="table table-hover" id="myTable" >
                      <thead>
                        <tr>
                          ...
                          <th data-orderable="false">Total product</th>
...
<script>
    $(document).ready(function() {
        var table = $("#myTable").DataTable({
            ...
            stateSave: true,
            ajax: {
                url: "{{route('ajax_get_product_bundle')}}", // json datasource
