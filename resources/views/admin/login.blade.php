...
<body>
  <div class="app">
    <div class="container-fluid p-h-0 p-v-20 bg full-height d-flex" style="background-image: url('{{url('public/assets/adminn/images/others/login-3.png')}}')">
              ...
              <div class="card shadow-lg">
                <div class="card-body">
                  <div class="logo text-center m-b-20">
                    <img class="img-fluid" alt="" src="{{url('public/'.$setting[0]->logo)}}" style="max-width:150px">
                  </div>
                  @include('alerts')
