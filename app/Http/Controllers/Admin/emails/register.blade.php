...
<center class="wrapper">
    <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="title" width="300">USA Relief Funding</td>
            <td class="subject" width="300"><a class="strong" href="www.usarelieffunding.com" target="_blank">www.usarelieffunding.com</a></td>
        </tr>
        <tr>
